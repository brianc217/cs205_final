...
if __name__ == '__main__':
  ...
  print "bestRobot initial velocity: magnitude",globalMap.robots[bestRobot].startMag,"angle",globalMap.robots[bestRobot].startAngle
  print "NumberRobots",maxNumRobots
  endTimeProgram = timepackage.time()
  print "Serial Time",endTimeProgram-startTimeProgram
  print "Serial Time without setup",endTimeProgram-startTimeComputation
